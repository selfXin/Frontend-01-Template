...
class Request {
    constructor(options) {
        ...
        if (this.headers['Content-Type'] == 'application/json') {
            this.bodyText = JSON.stringfiy(this.body);
...
void async function() {
    ...
    let dom = parseHTML.parseHTML(res.body)
    ...
    // var readStream = fs.createReadStream('vp.jpg');


    let result = path.join(__dirname,'brandNewImg.jpg');
    let gm1 = gm(1000, 1000, "#fff");


    render(gm1,dom);
   

    gm1.write(result, function (err,a,b) {
        // console.log(err,a,b)
      // ...
    });
